...
import { Copy, Check, Github, Linkedin, Instagram, MessageCircle } from "lucide-react";
import Wordmark from "@/components/ui/Wordmark";
import { contacto } from "@/data/contacto";

const ICONOS = { GitHub: Github, LinkedIn: Linkedin, Instagram, WhatsApp: MessageCircle };
